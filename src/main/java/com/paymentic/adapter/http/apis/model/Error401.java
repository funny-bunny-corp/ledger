...
public class Error401   {
  ...
  /**
   **/
  public Error401 code(String code) {
    this.code = code;
    return this;
  }
  ...
  /**
   **/
  public Error401 description(String description) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.code, error401.code) &&
        Objects.equals(this.description, error401.description);
  }
